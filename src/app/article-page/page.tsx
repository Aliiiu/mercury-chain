...
const ArticlePage = () => {
	...
	useEffect(() => {
		// If there's no authReq, don't set up the interval.
		if (!authReq) return;
		...
		// Set up the interval.
		const intervalSig = setInterval(checkAuthStatus, 2000);

		// Clear the interval when the component unmounts or authReq changes.
